...
#
# Generated by Vivado on Tue Nov 27 12:26:09 CST 2018
...
# Script info
echo -e "v7_bd.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb v7_bd.wdb xsim.dir)
