...
#
# Generated by export_simulation on Wed Jan 16 13:13:58 CST 2019
#
################################################################################
...
'-reset_run' switch to the './sync_fifo_gth_40.sh' script.

./sync_fifo_gth_40.sh -reset_run
...
./sync_fifo_gth_40.sh -noclean_files

For more information on the script, please type './sync_fifo_gth_40.sh -help'.
