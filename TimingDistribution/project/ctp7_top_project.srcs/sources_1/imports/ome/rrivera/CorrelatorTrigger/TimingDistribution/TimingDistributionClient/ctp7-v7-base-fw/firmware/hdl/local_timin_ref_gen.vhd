...
--============================================================================ 
  ...
  signal s_bc0, s_bco_d1, s_bc0_240_edge : std_logic;
...
--============================================================================
   ...
   s_bco_d1 <= bc0_i when rising_edge(clk_240_i);
  
   s_bc0_240_edge <= (not s_bco_d1 and bc0_i ) when rising_edge(clk_240_i);
